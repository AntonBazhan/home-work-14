        ...
        <Row type="flex" gutter={16}>
          {this.props.photoList &&
            this.props.photoList.map((photo) => (
              <Col span={8} key={photo.id} style={{ marginBottom: 10 }}>
                <PhotoCard data-test="photo-card" photo={photo} />
              </Col>
            ))}
        </Row>
        <button
          onClick={() => this.props.getAlbumPhotos()}
...
export default connect(mapStateToProps, { getAlbumPhotos })(
  UnconnectedPhotoList
);
